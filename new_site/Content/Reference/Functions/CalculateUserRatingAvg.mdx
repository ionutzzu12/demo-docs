---
title: CalculateUserRatingAvg
docTags: 
createdAt: Tue Jun 30 2026 17:16:59 GMT+0300 (Eastern European Summer Time)
---

Returns the average feedback rating for a knowledge article.
...
<Paragraph indent="1">
  In the above example, the application retrieves all the feedback records related to the current knowledge article and returns the average of rating numbers in the feedback.
</Paragraph>
