---
title: CurrentUserOrganizationalUnit
docTags: 
...
<hint type="info">
  ...
  Use the [CurrentUserOrganizationalUnitName](CurrentUserOrganizationalUnitName.mdx) function to return the name of the organizational unit of the current session.
</hint>
...
<Image src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/IMFKsCOCkDui3Tfhh-Wcj_currentuserorganizationalunit.png" position="flex-start" size="40" indent="1" initialPath="../../Resources/Images/help-images/currentUserOrganizationalUnit.png" githubPath="Content/Resources/Images/help-images/currentUserOrganizationalUnit.png" showCaption="false"></Image>
