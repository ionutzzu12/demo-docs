...
Removes line breaks to make the token fit on a single line. An example is:
...
| ---------------- | ------------------------------------------ |
| RemoveLineBreaks | Input string to perform Remove Line Breaks |
...
$(RemoveLineBreaks("Now is the winter of our discontent,made glorious summer by this son of York."))
