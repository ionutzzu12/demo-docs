...
If you do not see some of the tabs listed here, they may be hidden, click the :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/QguiND0-Jf_eYUcrBPGk3_unhide-tabs.png" alt caption size="10" width="14" height="14"} icon at the right corner of the tabs list and select the tab you wish to un-hide.
