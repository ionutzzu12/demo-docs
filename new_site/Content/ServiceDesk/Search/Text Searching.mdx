...
There are different types of search that can be used in \{\{FRS\_VARS.ProductName}} to find the information you need.
...
The results are sorted by relevance, showing the best matches first, unless you do one of the following:
...
In the \{\{FRS\_VARS.Self\_Service\_Mobile\_portal}} portal, the searched keyword is highlighted in the search results. This feature helps to you to identify the most relevant records in the search results. You can also change the default text in the search box by configuring the block templates. Refer to [Customizing Block and Template Parts](../../Configure/SelfServiceSetup/Customizing-Block-and-Template-Parts.mdx).

To clear the search field in the \{\{FRS\_VARS.Self\_Service\_Mobile\_portal}} portal, click :inlineImage[]{src="https://archbee-image-uploads-qa.s3.amazonaws.com/yzXkkCTORWlcwRG_AVHKZ/8X7SsWPkThU6J5pbP_MBx_deletesearch.png" alt caption size="10" width="14" height="13"} icon.
...
Administrators enable search features from the layout page for each business object. Refer to [Using Layouts](../../Configure/Layouts/Layouts.mdx) for more information..
