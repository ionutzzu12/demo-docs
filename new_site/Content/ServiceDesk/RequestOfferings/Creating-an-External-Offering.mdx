---
title: Creating an External Offering
docTags: 
...
7. Click **Change Image** to edit the default image. See [Default Icons for Request Offerings](Default-Icons-for-Request-Offerings.mdx).
...
| Open In                                    | Specifies how the service request appears. Select from the drop-down list:<br />**New Window**: Opens the service request in a new browser window.<br />**Workspace**: Opens a new workspace inside \{\{FRS\_VARS.ProductName}}.<br />**Inside Service Catalog**: Opens the service request inside the **Service Catalog** workspace within \{\{FRS\_VARS.ProductName}}.                                                             |
